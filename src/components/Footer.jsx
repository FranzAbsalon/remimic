                ...
                <div class="grid grid-cols-2">
                    ...
                    <div class="mb-6 md:mb-0">
                        ...
                        <ul class="text-white text-2xl font-medium">
                            ...
                            <li class="mb-4">
                                <a href="#" class="hover:underline text-gray-300">About</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline text-gray-300">Pricing</a>
                            </li>
                            <li>
                                <a href="#" class="hover:underline text-gray-300">FAQs</a>
                            </li>
                        </ul>
                    </div>
